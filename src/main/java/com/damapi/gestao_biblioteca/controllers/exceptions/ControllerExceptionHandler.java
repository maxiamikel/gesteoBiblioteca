...
public class ControllerExceptionHandler {
	...
	public ResponseEntity<CommonExceptions> objectNotFoundException(ObjectNotFoundException e, ServletRequest request) {
		CommonExceptions error = new CommonExceptions(System.currentTimeMillis(), HttpStatus.NOT_FOUND.value(),
				e.getMessage());
		// CommonExceptions err = new CommonExceptions(System.currentTimeMillis(),
